...
export function AbstentionCard({ reason, effectiveBand, unmetReviewBreach }: Props) {
  ...
  return (
    <div className="rounded-xl border border-[#D97706]/30 bg-[#D97706]/5 p-5">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2 text-[#F59E0B] font-semibold text-sm tracking-wide">
        ...
        <span className="text-[10px] font-bold uppercase tracking-wider text-[#F59E0B]/70">Attention</span>
      </div>
      ...
      <div className="border-t border-[#D97706]/20 pt-4">
        ...
        <div className="flex items-baseline gap-2 mb-1">
          ...
          <span className="text-sm font-medium text-white/90">Holding at Yellow floor</span>
        </div>
        <p className="text-xs text-white/50 pl-4">
      ...
      {unmetReviewBreach && (
        <div className="mt-5 pt-4 border-t border-red-500/20 flex items-center gap-2">
          ...
          <span className="text-xs text-white/50">Unreviewed past 15 min.</span>
        </div>
      )}
    </div>
  );

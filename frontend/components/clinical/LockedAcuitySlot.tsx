...
export function LockedAcuitySlot() {
  return (
    <div className="p-4 rounded-xl border border-white/10 bg-white/[0.02] flex flex-col gap-2">
      ...
      <details className="text-[10px] text-white/30 group">
        <summary className="cursor-pointer hover:text-white/50 transition-colors list-none inline-flex items-center gap-1">

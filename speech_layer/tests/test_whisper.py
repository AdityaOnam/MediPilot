...
Uses the real audio fixtures available in the repo root (test.ogg, test2.ogg,
...
TEST_EN = os.path.join(REPO_ROOT, "test2.ogg")   # "I am having chest pain and I am sweating as well."
TEST_HI = os.path.join(REPO_ROOT, "test.ogg")    # Hindi: "yeh bas testing ke liye hai"
TEST_HINGLISH = os.path.join(REPO_ROOT, "test3.ogg")  # Hindi grammar + English loanwords (chest/pain)
TEST_SILENCE = os.path.join(os.path.dirname(__file__), "test_silence.wav")
TEST_NEAR_SILENCE = os.path.join(os.path.dirname(__file__), "test_near_silence.wav")
